...
import { UPDATE_LEAD } from '../../../home/queries';
...
function UpdateClientModal({ closeModal, clientCurrentId }) {
    ...
    const submitHandler = async (e) => {
        ...
        const createDetailsResponse = await updateLead({ variables: { id, data } });
